  ...
  <div class="row">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="chart-area">
            <line-chart v-if="usersLoaded" :chartdata="chartdata" :options="options"/>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="col-xl-4 col-lg-5">
      <div class="card shadow mb-4">
        <!-- Card Header - Dropdown -->
        <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
          <h6 class="m-0 font-weight-bold text-primary">Registration Analysis</h6>
          <div class="dropdown no-arrow">
            <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
            </a>
            <div class="dropdown-menu dropdown-menu-right shadow animated--fade-in" aria-labelledby="dropdownMenuLink">
              <div class="dropdown-header">My Referrals:</div>
              <a class="dropdown-item" href="#">Action</a>
              <a class="dropdown-item" href="#">Another action</a>
              <div class="dropdown-divider"></div>
              <a class="dropdown-item" href="#">Report Error</a>
            </div>
          </div>
        </div>
        <!-- Card Body -->
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <div class="text-center">
            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="storage/assets/img/undraw_posting_photo.svg" alt="">
          </div>
...
import LineChart from '~/components/charts/UsersChart.vue'
import DoughnutChart from '~/components/charts/ReferralsChart.vue'
...
export default {
  ...
  async mounted () {
    ...
    try {
      const { userslist } = await fetch('/api/chart/users')
      
      this.usersChart = userslist
